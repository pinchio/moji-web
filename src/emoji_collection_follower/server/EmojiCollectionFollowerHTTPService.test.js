...
describe.skip('EmojiCollectionFollowerHTTPService', function() {
    describe('post', function () {
        var stored_emoji_collection_follower
        ...
        it('should create emoji_sent emoji_collection_follower and increment send_count', function(done) {
            request({
                    url: get_url('/_/api/emoji_collection_follower')
                  , method: 'POST'
                  , json: {
                        emoji_collection_follower: 'emoji_sent'
                      , properties: {
